...
public class Operation{
	...
	public Operation(Context context, int mode, Map<String, String> params, String recepient){
		this.context = context;
		this.mode = mode;
		this.params = params;
		...
		if(code.equals(CommonUtilities.OPERATION_DEVICE_INFO)){
            ...
            double latitude = 0;
	            ...
	            if(mode == CommonUtilities.MESSAGE_MODE_GCM){
	            	...
	            	smsManager.sendTextMessage(recepient, null, "Battery Level : "+phoneState.getBatteryLevel()+", Total Memory : "+deviceInfo.formatSize(deviceInfo.getTotalInternalMemorySize()+deviceInfo.getTotalExternalMemorySize())+", Available Memory : "+deviceInfo.formatSize(deviceInfo.getAvailableInternalMemorySize()+deviceInfo.getAvailableExternalMemorySize()), null, null);
	            }
        	...
        	double latitude = 0;
        	 ...
        	 JSONObject obj=new JSONObject();
	            ...
	            if(mode == CommonUtilities.MESSAGE_MODE_GCM){
	            	...
	            	smsManager.sendTextMessage(recepient, null, "Longitude : "+longitude+",Latitude : "+latitude, null, null);
	            }
	       	 }catch (JSONException e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
        	...
        	try {
        		...
        		}else if(jobj.get("Notification").toString() != null || jobj.get("Notification").toString().equals("")){
        			notification = jobj.get("Notification").toString();
        		}else{
        			notification = "";
        		}
        	...
        	try {
	            ...
	            if(mode == CommonUtilities.MESSAGE_MODE_GCM){
	            	...
	            	smsManager.sendTextMessage(recepient, null, "Camera "+cammode+" Successfully", null, null);
	            }
        	...
        	try {
				...
				if(jobj.get("function").toString().equalsIgnoreCase("encrypt")){
					encryptFunc = true;
				}else if (jobj.get("function").toString().equalsIgnoreCase("decrypt")){
					encryptFunc = false;
				}else{
